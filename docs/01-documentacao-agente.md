...
Muitas pessosas tem dificuldade de entender conceitos básicos de finanças pessoais, como reserva de emergência, tipos de investimentos e como organizar seus gastos.
...
- Erro/Limitação: "Não posso recomendar onde investir, mas possto te explicar como cada tipo de investimetno funciona!"
...
| LLM | [Ollama (local)](https://streamlit.io/) |
